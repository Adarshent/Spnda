...
\paragraph{Reproducibility.} Code, evaluation scripts, and all raw experimental traces are publicly available at \url{https://github.com/Adarshent/Spnda}. The Spanda metric is released as a Python package installable via \texttt{pip install spanda}.
