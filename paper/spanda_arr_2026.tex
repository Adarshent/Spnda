...
Qwen-27B & GSM8K & 250 & 61.2\% & \textbf{0.889} & --- & \textbf{1.43} & 0.346 & $\mathbf{1.89} \times \mathbf{10^{-28}}$ \\
...
Rather than framing exact-match and neural NLI as mutually exclusive alternatives, our empirical findings define a principled \textbf{2-Tier Cascaded Guardrail} architecture for production inference:
