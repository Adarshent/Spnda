"""
Spanda Gateway (BRHMN Labs Enterprise Guardrail Proxy).
    ...
    def do_GET(self):
        ...
        if self.path in ("/health", "/healthz", "/v1/health"):
            self._send_json(200, {
                ...
                "organization": "BRHMN Labs Private Limited",
                "version": "0.2.2",
...
def run_gateway(
    ...
    print(f"⚡ Spanda Enterprise Gateway (BRHMN Labs) active on http://0.0.0.0:{port}")
